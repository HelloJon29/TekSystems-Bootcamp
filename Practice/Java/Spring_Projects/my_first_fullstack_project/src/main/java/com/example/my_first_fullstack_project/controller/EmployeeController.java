...
public class EmployeeController {
    ...
    // Constructor version of Dependency Injection
    @Autowired
    public EmployeeController(EmployeeService employeeService) {
        this.employeeService = employeeService;
    }

    @GetMapping("/") // goes to homepage
    ...
    public String saveEmployee(@ModelAttribute("employee") @Valid Employee employee, BindingResult bindingResult) {
        // check for validation, return to same page if the input does not validate with the model
